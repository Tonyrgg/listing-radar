export interface CrmSelectors {
  ...
  propertyCadastralSectionUrban: string;
  propertyCadastralSheet: string;
...
export const crmSelectors: CrmSelectors = Object.assign(Object.fromEntries([
  ...
  propertyCadastralSectionUrban: '.flex:has(> div > label:has-text("Catasto Sezione Urbana"))',
  propertyCadastralSheet: '.flex:has(> div > label:has-text("Catasto Foglio"))',
  ...
  propertyType: 'c-picklist:has(label:text-is("Tipologia Immobile"))',
  propertySubtype: 'c-picklist:has(label:text-is("Sottotipologia Immobile"))',
  propertyFloor: 'c-picklist:has(label:text-is("Piano Immobile"))',
