...
revoke all on function public.persist_property_lifecycle_observation_atomic(uuid, uuid, jsonb, jsonb, jsonb, text, jsonb, jsonb, text)
  from public, anon, authenticated;
grant execute on function public.persist_property_lifecycle_observation_atomic(uuid, uuid, jsonb, jsonb, jsonb, text, jsonb, jsonb, text)
  to service_role;
...
comment on function public.persist_property_lifecycle_observation_atomic(uuid, uuid, jsonb, jsonb, jsonb, text, jsonb, jsonb, text) is
  'Applica una observation V2 in una singola transazione PostgreSQL; p_failure_point è riservato ai test di rollback.';
